...
public class TreatTypeGoodRedBeanCake implements ITreatTypeGood, Serializable{
    private Bitmap bitmap;
    private final int RECT_HEIGHT;
    private final int RECT_WIDTH;
    private int pointValue;
    private int type = Treat.RED_BEAN_CAKE;

    public TreatTypeGoodRedBeanCake(Context context){
        RECT_HEIGHT = (int)(Constants.SCREEN_HEIGHT * .159);
        RECT_WIDTH = (int)(RECT_HEIGHT * .8);
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.redbeancake);
