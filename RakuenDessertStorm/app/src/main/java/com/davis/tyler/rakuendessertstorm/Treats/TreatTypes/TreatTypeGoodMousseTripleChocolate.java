...
public class TreatTypeGoodMousseTripleChocolate implements ITreatTypeGood {
    private Bitmap bitmap;
    private int RECT_HEIGHT;
    private int RECT_WIDTH;
    private int pointValue;
    private int type = Treat.MOUSSE_TRIPLE_CHOCOLATE;

    public TreatTypeGoodMousseTripleChocolate(Context context){
        RECT_HEIGHT = (int)(Constants.SCREEN_HEIGHT * .109);
        RECT_WIDTH = (int)(RECT_HEIGHT * .8);
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.triplechocomousse);
