...
public class TreatTypeGoodGiantMatchaParfait implements ITreatTypeGood, Serializable{

    private Bitmap bitmap;
    private final int RECT_HEIGHT;
    private final int RECT_WIDTH;
    private int pointValue;
    private int type = Treat.GIANT_MATCHA_PARFAIT;

    public TreatTypeGoodGiantMatchaParfait(Context context){
        RECT_HEIGHT = (int)(4 * Constants.SCREEN_HEIGHT * .119);
        RECT_WIDTH = (int)(RECT_HEIGHT * .8);
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.matchaparfeit);
