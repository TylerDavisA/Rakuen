...
/**
 * Created by Tadto on 3/26/2018.
 */

public class TreatTypeGoodMintChipSandwich implements ITreatTypeGood {
    private Bitmap bitmap;
    private int RECT_HEIGHT;
    private int RECT_WIDTH;
    private int pointValue;
    private int type = Treat.MINT_CHIP_SANDWICH;

    public TreatTypeGoodMintChipSandwich(Context context){
        RECT_HEIGHT = (int)(Constants.SCREEN_HEIGHT * .119);
        RECT_WIDTH = (int)(RECT_HEIGHT * .8);
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.mintchipsandwich);
