...
public class TreatTypeGoodBuffMagnet implements ITreatTypeGood {
    private Bitmap bitmap;
    private final int RECT_HEIGHT;
    private final int RECT_WIDTH;
    private int pointValue;
    private int type = Treat.BUFF_MAGNET;

    public TreatTypeGoodBuffMagnet(Context context){
        RECT_HEIGHT = (int)(Constants.SCREEN_HEIGHT * .119);
        RECT_WIDTH = (int)(RECT_HEIGHT);
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.magnet);
