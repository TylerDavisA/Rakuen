...
public class TreatTypeGoodMatchaCakeRound implements ITreatTypeGood {
    private Bitmap bitmap;
    private int RECT_HEIGHT;
    private int RECT_WIDTH;
    private int pointValue;
    private int type = Treat.MATCHA_CAKE_ROUND;

    public TreatTypeGoodMatchaCakeRound(Context context){
        RECT_HEIGHT = (int)(Constants.SCREEN_HEIGHT * .119);
        RECT_WIDTH = (int)(RECT_HEIGHT * .7);
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.matchacakeround);
