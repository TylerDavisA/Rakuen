...
public class TreatTypeGoodCabbage implements ITreatTypeGood {
    private Bitmap bitmap;
    private int RECT_HEIGHT;
    private int RECT_WIDTH;
    private int pointValue;
    private int type = Treat.CABBAGE;

    public TreatTypeGoodCabbage(Context context){
        RECT_HEIGHT = (int)(Constants.SCREEN_HEIGHT * .1);
        RECT_WIDTH = (int)(RECT_HEIGHT * 1.2);
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.cabbage);
