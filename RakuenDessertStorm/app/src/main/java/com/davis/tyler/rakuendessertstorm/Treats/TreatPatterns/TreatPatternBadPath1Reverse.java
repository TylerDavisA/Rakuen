...
public class TreatPatternBadPath1Reverse implements TreatPattern{
    ...
    public TreatPatternBadPath1Reverse(TreatFactory treatFactory, int type){
    ...
    public void makePattern(TreatSmall[] treatSmalls, TreatGiant[] treatGiants, TreatBad[] treatBads) {
        System.out.println("Pattern PATH1 REVERSE");
        isDone = false;
        ...
        treatFactory.spawnSmallTreatByNumber(screenWidthUnit * 3, screenHeightUnit * -1, type1, treatSmalls);
        treatFactory.spawnSmallTreatByNumber(screenWidthUnit * 3, screenHeightUnit * -3, type2, treatSmalls);
        treatFactory.spawnSmallTreatByNumber(screenWidthUnit * 3, screenHeightUnit * -5, type1, treatSmalls);
        treatFactory.spawnBadTreat(screenWidthUnit * 3, screenHeightUnit * -7, treatBads);
        ...
        treatFactory.spawnSmallTreatByNumber(screenWidthUnit * 9, screenHeightUnit * -5, type1, treatSmalls);
        treatFactory.spawnSmallTreatByNumber(screenWidthUnit * 9, screenHeightUnit * -7, type2, treatSmalls);
