...
public class TreatTypeGoodDonutRedPowder implements ITreatTypeGood {
    private Bitmap bitmap;
    private final int RECT_HEIGHT ;
    private final int RECT_WIDTH ;
    private int pointValue;
    private int type = 0;
    public TreatTypeGoodDonutRedPowder(Context context){
        RECT_HEIGHT = (int)(Constants.SCREEN_HEIGHT * .08);
        RECT_WIDTH = (int)(RECT_HEIGHT * 1.105f);
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.donutredpowder);
        pointValue = 50;
