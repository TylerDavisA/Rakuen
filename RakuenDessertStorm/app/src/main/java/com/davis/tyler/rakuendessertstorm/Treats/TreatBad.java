...
public class TreatBad implements Treat, Parcelable{
    private Coordinates location;
    private IObjectMove move, moveBuffer;
    private ITreatTypeBad type;
    ...
    public TreatBad(ObjectMoveFactory moveFactory, Coordinates location){
    ...
    public void parcelableInit(TreatFactory treatFactory, ObjectMoveFactory objectMoveFactory){
        ...
        type = treatFactory.getTreatBad(typeValue);
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        if(move instanceof ObjectMoveTreatFall){
