...
public class TreatTypeGoodChocoBananaSandwich implements ITreatTypeGood, Serializable {
    private Bitmap bitmap;
    private int RECT_HEIGHT;
    private int RECT_WIDTH;
    private int pointValue;
    private int type = Treat.CHOCO_BANANA_SANDWICH;

    public TreatTypeGoodChocoBananaSandwich(Context context){
        RECT_HEIGHT = (int)(Constants.SCREEN_HEIGHT * .119);
        RECT_WIDTH = (int)(RECT_HEIGHT * .8);
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.chocobananasandwich);
